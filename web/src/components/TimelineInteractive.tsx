  ...
  const timelinePoints: TimelinePoint[] = [
    {
      ...
      color: '#457B9D',
      icon: '🗳️',
      description: 'Political satire dominated humor during election cycles, with sharp commentary on campaigns and results.',
      keyEvents: [
        'Trump elected (2016)',
      ...
      graphData: [
        { month: 'Jan 2016', value: 45 },
        { month: 'Jun 2016', value: 72 },
        { month: 'Nov 2016', value: 100 },
        { month: 'Jan 2017', value: 68 },
        { month: 'Jan 2020', value: 55 },
        { month: 'Jun 2020', value: 78 },
        { month: 'Nov 2020', value: 98 },
        { month: 'Jan 2021', value: 70 }
      ],
      position: 15,
    ...
    },
    {
      ...
      color: '#E63946',
      icon: '😷',
      description: 'The pandemic reshaped humor with themes of masks, Zoom calls, quarantine, and social distancing.',
      keyEvents: [
      ...
      graphData: [
        { month: 'Jan 2020', value: 8 },
        { month: 'Feb 2020', value: 18 },
        { month: 'Mar 2020', value: 100 },
        { month: 'Jun 2020', value: 95 },
        { month: 'Dec 2020', value: 88 },
        { month: 'Mar 2021', value: 75 },
        { month: 'Jun 2021', value: 52 },
        { month: 'Dec 2021', value: 35 }
      ],
      position: 50,
    ...
    },
    {
      ...
      color: '#8D5B4C',
      icon: '🌍',
      description: 'International tensions and conflicts became a recurring theme, reflecting global anxiety.',
      keyEvents: [
      ...
      graphData: [
        { month: 'Jan 2022', value: 25 },
        { month: 'Feb 2022', value: 88 },
        { month: 'Mar 2022', value: 100 },
        { month: 'Apr 2022', value: 92 },
        { month: 'Jun 2022', value: 78 },
        { month: 'Sep 2022', value: 65 },
        { month: 'Dec 2022', value: 58 },
      ...
      wordData: [
        { word: 'war', count: 389 },
        { word: 'ukraine', count: 356 },
        { word: 'peace', count: 298 },
        { word: 'conflict', count: 276 },
        { word: 'crisis', count: 234 }
      ],
      trendsData: [
        { month: 'Jan', interest: 28 },
        { month: 'Feb', interest: 100 },
        { month: 'Mar', interest: 95 },
        { month: 'Apr', interest: 78 },
    ...
    },
    {
      ...
      color: '#2A9D8F',
      icon: '🌡️',
      description: 'Environmental humor grew steadily, becoming increasingly urgent as climate events intensified.',
      keyEvents: [
      ...
      graphData: [
        { month: 'Jan 2019', value: 42 },
        { month: 'Jun 2019', value: 58 },
        { month: 'Jan 2020', value: 52 },
        { month: 'Jan 2021', value: 61 },
        { month: 'Jun 2021', value: 68 },
        { month: 'Jan 2022', value: 75 },
        { month: 'Jun 2022', value: 82 },
        { month: 'Dec 2023', value: 95 }
      ],
      position: 90,
      ...
      wordData: [
        ...
        { word: 'earth', count: 312 },
        { word: 'weather', count: 289 },
        { word: 'crisis', count: 267 }
      ],
      trendsData: [
        { month: 'Jan', interest: 45 },
        { month: 'Feb', interest: 52 },
    ...
    <>
      <div className="h-full flex flex-col">
        ...
        <p className="text-center comic-text mb-6 text-sm">
          <span className="comic-title text-[#457B9D]">🗳️ Elections</span> • <span className="comic-title text-[#E63946]">😷 Pandemic</span> • <span className="comic-title text-[#8D5B4C]">🌍 Conflicts</span> • <span className="comic-title text-[#2A9D8F]">🌡️ Climate</span> — Click to explore!
        </p>
        ...
        <div className="flex-1 relative mb-6">
          ...
          <div 
            ...
            style={{
              background: 'linear-gradient(90deg, #457B9D 0%, #E63946 40%, #8D5B4C 70%, #2A9D8F 100%)',
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {/* Label */}
                  <div 
                    className={`absolute ${isAbove ? 'bottom-full mb-20' : 'top-full mt-20'} left-1/2 transform -translate-x-1/2 whitespace-nowrap`}
                  >
                    <div className="comic-title text-xs px-2 py-1 bg-white border-2 border-[#1A1A1A] rounded" style={{ color: point.color }}>
                      {point.title}
                    </div>
                  </div>
                  ...
                  <AnimatePresence>
                    {isHovered && (
                      <motion.div
                        ...
                        className={`absolute ${isAbove ? 'top-full mt-2' : 'bottom-full mb-2'} left-1/2 transform -translate-x-1/2 z-50`}
                      >
                        <div className="w-56 p-4 bg-white border-3 border-[#1A1A1A] rounded-lg shadow-[0_0_15px_rgba(0,0,0,0.2)]" style={{ boxShadow: '4px 4px 0 #1A1A1A', backgroundColor: `${point.color}10` }}>
                          ...
                          <div className="mt-2 flex gap-1 flex-wrap">
                            {point.keywords.slice(0, 3).map((kw, i) => (
                              <span key={i} className="text-[9px] px-2 py-0.5 bg-white/60 rounded-full border border-[#1A1A1A]/20">
                                #{kw}
                              </span>
                            ))}
                          </div>
