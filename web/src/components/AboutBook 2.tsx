    ...
    <div className="h-full flex flex-col">
      ...
      <div className="grid grid-cols-2 gap-6 flex-1">
        ...
        <div>
          ...
          {/* Citation */}
          <div className="border-4 border-[#1A1A1A] p-4 bg-[#FFF9E6]" style={{ boxShadow: '3px 3px 0 #1A1A1A' }}>
            <div className="inline-block mb-2 px-3 py-1 bg-[#8D5B4C] border-2 border-[#1A1A1A]">
              <h3 className="comic-title text-xs text-[#FDFDF8]">How to Cite</h3>
            </div>
            <p className="handwritten text-[10px] text-[#8B4513] leading-relaxed">
